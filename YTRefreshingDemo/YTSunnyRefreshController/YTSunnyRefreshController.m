...
@interface YTSunnyRefreshController ()
...
@implementation YTSunnyRefreshController

#pragma clang diagnostic ignored "-Wobjc-designated-initializers"
- (instancetype)initWithFrame:(CGRect)frame {
    return [[[NSBundle mainBundle] loadNibNamed:@"YTSunnyRefreshController" owner:self options:nil] firstObject];
}
